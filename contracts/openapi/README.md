...
- the Auth.js cookie session for protected operations; registration and the
  BFF credentials-verification boundary are anonymous entry points;
...
TypeScript transport types are generated from this file; no handwritten DTO
