...
const definitions: AchievementDefinition[] = [
  ...
  // Скрытые пасхалки: до открытия возвращаются клиенту без названия и условия.
  // Оставлены две отсылочные (secret-ledger — выше, в ACTIVITY; secret-coffee-path — здесь).
  { id: "secret-coffee-path", title: "Это путь. К кофе", description: "Оплатить кофе и вступить в орден кофеманов. Таков путь", category: "ACTIVITY", icon: "coffee", metric: "coffeeExpensesPaid", target: 1, hidden: true },
]
